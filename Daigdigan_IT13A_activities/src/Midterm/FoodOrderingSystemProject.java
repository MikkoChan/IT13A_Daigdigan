...
public class FoodOrderingSystemProject{
    static final String FILE_NAME = "C:\\Users\\binx\\Desktop\\For Midterm Project.txt";
    static final int SHIFT = 3;

    static String[] foodItems = {
        "Pizza", "Burger", "Fries", "Spaghetti",
        "Fried Chicken", "Milk Tea", "Soda"
    };

    static float[] foodPrices = {
        250, 120, 60, 150, 180, 100, 40
    };
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                System.out.println("Paalam,labyu!");
                break;
            } else {
